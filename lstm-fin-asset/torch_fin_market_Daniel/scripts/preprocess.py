...
#  get file from Amibroker exploration
def load_data(file_name):
    data = pd.read_csv(Path(data_dir, file_name),parse_dates=['Date/Time'],dayfirst=True)
...
def prep_data(
    ...
    # subset data
    train_df = train_df[list_feature]
    test_df = test_df[list_feature]
